...
layui.define(["jquery", "layer"], function (exports) {
    ...
    var miniTheme = {
        ...
        config: function (bgcolorId) {
            var bgColorConfig = [
                {
                    headerRightBg: 'rgb(189,23,37)', //头部右侧背景色
                    ...
                    headerLogoBg: 'rgb(189,23,37)', //logo背景颜色,
                    headerLogoColor: '#ffffff', //logo字体颜色,
                    leftMenuNavMore: 'rgb(191, 187, 187)', //左侧菜单更多下拉样式,
                    leftMenuBg: 'rgb(189,23,37)', //左侧菜单背景,
                    leftMenuBgThis: '#ae1919', //左侧菜单选中背景,
                    leftMenuChildBg: 'rgba(0,0,0,.3)', //左侧菜单子菜单背景,
                    leftMenuColor: 'rgba(255,255,255,.7)', //左侧菜单字体颜色,
